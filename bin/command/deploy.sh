...
Registry::Help::row "" "${GREEN}-x${NC} ${HELP_DESC}Enables Xdebug. You can set environment variable ${CYAN}SPRYKER_XDEBUG_ENABLE=1${HELP_DESC} instead of using this option.${NC}"
