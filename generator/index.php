...
file_put_contents(
    $deploymentDir . DS . 'images' . DS . 'baked' . DS . 'slim' . DS . 'application' . DS . 'Dockerfile',
    $twig->render('images' . DS . 'baked' . DS . 'slim' . DS . 'application' . DS . 'Dockerfile.twig', $projectData)
);
