...
class StoreSpecificSessionExecutor implements DataExecutorInterface
{
    /**
    ...
    public function exec(array $projectData): array
    {
        ...
        foreach ($projectData[ProjectDataRegionsConstants::REGIONS_KEY] as $regionName => $regionData) {
            ...
            $keyValueStoreNamespace = $regionServices[ProjectDataServicesConstants::SESSION_KEY][ProjectDataServicesConstants::SERVICES_NAMESPACE_KEY];
            $storeSpecific[$regionName][ProjectDataStoreSpecificConstants::SPRYKER_SESSION_BE_NAMESPACE] = $keyValueStoreNamespace;
        }
