...
* `environment-configuration: secrets: grant:`—IAM users' permissions. `limited` grants read while `public` grants read and write permissions. The default one is `limited`.
...
* `environment-configuration: params: grant:`—IAM users' permissions. `limited` grants read while `public` grants read and write permissions. The default one is `limited`.
